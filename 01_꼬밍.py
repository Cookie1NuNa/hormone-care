...
def display_hormone_guide(day):
    ...
    # ✨ 2단계 (황금기): Day 6 ~ 13 (동생의 28일 주기 기준 8일!)
   ...
   # 🌋 4단계 (황체기): Day 19 ~ 28 (동생의 28일 주기 기준 10일!)
    elif phase3_end < day <= 28:
        # 👇 1. 오늘이 4단계 10일 중 며칠 차인지 계산
        p4_day = day - phase3_end  
        
        # 동생 맞춤형 10일치 스케줄 딕셔너리
        p4_schedule = {
        ...
        * **💧 보습 듬뿍 & 진정 팩 필수 : **건조함주의
        ...
        st.write("")
        st.success("""
        **🗓️ [황체기 10일 생존 스케줄] 이중 자극 멈춰! 고민 없이 따라 하기 🛡️**
        ...
        * **Day 10 [마무리]  :** 🌿 데일리 진정 (내일이면 1단계! 튼튼한 보습으로 마무리)
        """)
