...
# 🌟 봉이의 31일 주기 맞춤형 구간 🌟
    ...
    ## ✨ 2단계 (황금기): Day 6 ~ 15
        ...
        # 👇 1. 오늘이 황금기 10일 중 며칠 차인지 계산 (1~10일)
        ...
        p2_schedule = {
            ...
            6: "💆‍♀️ 미백 마스크팩 단독 (🚨오늘은 기기 쉬는 날!)", 
            7: "🅱️ 기기 흡수 모드", 8: "🅰️ 리들샷 데이", 9: "🅱️ 기기 흡수 모드",
            10: "🅲 초음파 스페셜"
        }
        todays_pick = p2_schedule.get(p2_day, "🅱️ 기기 흡수 모드")

        st.markdown(f"#### ✨ 2단계: 황금기 (주기 {day}일차 - 영양 흡수 200%!)")
        st.caption("🏆 피부 재생력 만렙 구간! 리들샷과 기기를 적극 활용해서 깐달걀 피부 만들기!")
